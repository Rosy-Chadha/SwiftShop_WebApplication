...
export const productList = [
  ...
  {
    id: 201,
    img: '../img/Mens Coat 2.png',
    title: 'Mens coat one - Highlander',
    subtitle: 'Full Sleeve Men Jacket',
    description: 'Olive Green Solid Jacket, has a stand collar, 2 pockets, zip closure, long sleeves, straight hem, and polyster. Material: Cotton , Machine washable.',
    price: 499,
    inCart: false,
    inWishlist: false,
    amount: 0,
  ...
  {
    id: 202,
    img: '../img/Mens Coat 1 .png',
    title: 'Mens coat two - Roadster',
    subtitle: 'Black Solid Tailored Jacket',
    description: 'Black soild tailored jacket, has a mock collar, long sleeves, 2 pockets, hem with toggle. Material: Cotton , Machine washable',
    price: 699,
    inCart: false,
    inWishlist: false,
    amount: 0,
  ...
  },
  {
    ...
    title: 'Mens coat three - Locomotive',
    subtitle: 'Full Sleeve Soild Men Jacket',
    description: 'LCOCOMOTIVE Denim Cotton LIGHT BLUE Jacket. Fabric: Cotton Blend, Color: Light Blue, Machine washable.',
    price: 299,
    inCart: false,
    inWishlist: false,
    amount: 0,
  ...
  {
    id: 204,
    img: '../img/Mens Coat 5.png',
    title: 'Mens coat four - INVICTUS',
    subtitle: 'Men Brown Slim Fit Single-Breasted Casual Blazer',
    description: 'Brown casual balzer, has a notched lapel, sigle-breasted with double button closures, long sleeves, 5 pockets. Material : Polyster, Rayon, Spandex.; Machinewashable',
    price: 259,
    inCart: false,
    inWishlist: false,
    amount: 0,
  ...
  {
    id: 205,
    img: '../img/Mens Coat 4.png',
    title: 'Mens coat five - BELARIO',
    subtitle: 'Mens Slim Fit Single Breasted Blazer',
    description: 'Slim Fit, Dry Clean Only; Fabric : Cotton, Polyster, Closure: Single Button, Pockets 2.',
    price: 289,
    inCart: false,
    inWishlist: false,
    amount: 0,
